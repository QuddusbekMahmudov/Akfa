        ...
        <PageWrapper>
            <div className='w-full max-w-base mx-auto px-5 py-10 sm:py-20'>
                <h2 className='mb-5 opacity-60'>
                    <Link to='/' className='text-[#79c701]'>Главная/</Link> <Link to='/yangiliklar' className='text-[#79c701]'>Новости/</Link>Новости компании
                </h2>
                <h1 className='text-2xl sm:text-3xl md:text-5xl font-bold mb-4 sm:mb-16'>Новости компании</h1>
                <YangiliklarDropdown />
                <div className='w-full max-w-base mx-auto py-5 '>
...
export default KompaniyaYangiliklari;
