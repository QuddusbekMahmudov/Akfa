  ...
  return (
    <PageWrapper>
      <div className="w-full max-w-base mx-auto px-5 py-10 sm:py-20">
        ...
        <h1 className='text-2xl sm:text-3xl md:text-5xl font-bold mb-4 sm:mb-16'>Двухстворчатое окно</h1>
        ...
        <p className='mb-20 space-y-5 opacity-60 text-md sm:text-xl md:text-2xl'>
        ...
        <h2 className='space-y-5 opacity-60 mb-5 text-md sm:text-xl md:text-2xl'>Подходят для:</h2>
        <ul>
...
export default IkkiQavatliOyna
