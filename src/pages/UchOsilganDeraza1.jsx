...
const UchOsilganDeraza1 = () => {
  return (
    <PageWrapper>
      <div className="w-full max-w-base mx-auto px-5 py-10 sm:py-20">
        <h2 className='mb-10 opacity-60'>
          <Link to='/' className='text-[#79c701]'>Главная/</Link> <Link to={'/Profillar'} className='text-[#79c701]'>Профили/</Link>Rehau Delight
        </h2>
        <h1 className='text-2xl sm:text-3xl md:text-5xl font-bold mb-4 sm:mb-16'>Rehau Delight</h1>
...
export default UchOsilganDeraza1
