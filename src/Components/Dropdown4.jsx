...
const Dropdown3 = () => {
    ...
    return (
        ...
        >
            <Link to={'/ObektlarVaXizmatKorsatish'} className="dropdown-toggle opacity-70 flex items-center justify-between">
            ...
            {isOpen && (
                ...
                <li className='opacity-70 border-2 hover:text-[#63b700] transition-all duration-300' onClick={() => handleItemClick("Option 1")} style={{ padding: '12px 15px', cursor: 'pointer' }}>
                    <Link to="/YagonaPanjaraliOyna4">Установка окон</Link>
                </li>
                <li className='opacity-70 border-x-2 hover:text-[#63b700] transition-all duration-300' onClick={() => handleItemClick("Option 2")} style={{ padding: '12px 15px', cursor: 'pointer' }}>
                    <Link to={'/IkkiQavatliOyna4'}>Остекление квартир</Link>
                </li>
                ...
                <Link to={'/UchOsilganDeraza4'}>Остекление коттеджей</Link>
                </li>
                ...
                <Link to={'/DerazaBilan4'}>Ремонт окон</Link>
                </li>
                ...
                <Link to={'/EgriOynalar4'}>Скрытые петли</Link>
                </li>
